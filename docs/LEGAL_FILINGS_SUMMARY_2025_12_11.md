...
**Last Updated:** 2025-12-11 05:39:59
...
#### Answering Affidavit
- **File:** `ANSWERING_AFFIDAVIT_REFINED_2025_12_11.md`
- **Status:** Evidence Enhanced (v2025-12-11)
- **Key Claims:**
  - Trust breach (90%+ confidence)
  - Unauthorized transfers R900K (85%+ confidence)
  - Revenue stream hijacking (85%+ confidence)
- **Evidence:** JF1-JF13, SF1-SF10
- **Burden of Proof:** EXCEEDED 50%
- **Data Model Integration:** Entities v15, Events v35, Relations v25, Timeline v24

#### CIPC Companies Act Complaint
- **File:** `CIPC_COMPLAINT_REFINED_2025_12_11.md`
- **Status:** Evidence Enhanced (v2025-12-11)
- **Key Violations:**
  - Director misconduct (Peter Faucitt)
  - Fiduciary duty breaches
  - Financial misappropriation (R63M+)
- **Evidence:** SF2A, SF2B, SF9, JF1-JF13
- **Burden of Proof:** EXCEEDED 50%
- **Data Model Integration:** Entities v15, Events v35, Relations v25

### 2. Criminal Actions (95% Burden of Proof)

#### Commercial Crime Submission
- **File:** `COMMERCIAL_CRIME_REFINED_2025_12_11.md`
- **Status:** Evidence Enhanced (v2025-12-11)
- **Key Crimes:**
  1. **Theft (R63M)** - Peter Faucitt
     - Evidence: SF9 (Attorney letter), JF1 (Forensic Time Capsule), JF2 (Sales reports)
     - Quantum: R60,251,961.60 + $150,000 (~R2.8M) = ~R63M
     - Period: July 2023 - October 2025 (27 months)
     - Confidence: 95%+
     - Status: ACHIEVABLE
  
  2. **Identity Impersonation** - Rynette Farrar
     - Evidence: SF2A (Dual account access), SF2B (Subscription ownership)
     - Criminal element: Using Pete@regima.com to impersonate Peter
     - Confidence: 95%+
     - Status: ACHIEVABLE

#### POPIA Criminal Complaint
- **File:** `POPIA_COMPLAINT_REFINED_2025_12_11.md`
- **Status:** Evidence Enhanced (v2025-12-11)
- **Key Violations:**
  - Unauthorized data access (Rynette Farrar)
  - Unlawful data processing
  - Failure to secure information
  - Obstruction of access (Sage subscription control)
- **Evidence:** SF2A, SF2B, JF7, JF8D
- **Burden of Proof:** Strong (approaching 95%)
- **Data Model Integration:** Entities v15, Events v35

#### NPA Tax Fraud Report
- **File:** `NPA_TAX_FRAUD_REPORT_2025_12_11.md`
- **Status:** Evidence Enhanced (v2025-12-11)
- **Key Elements:**
  - R63M+ undeclared revenue (RegimA Zone UK)
  - Transfer pricing fraud
  - Inter-company loan schemes
  - Withholding funds from legitimate owner
- **Evidence:** SF9, JF1, JF2, JF3, SF1, SF1A, SF3
...
- **SF2A:** Sage User Access - Rynette Dual Accounts (June 2025)
- **SF2B:** Sage Subscription Expiry - Rynette Owner (August 2025)
- **SF9:** Attorney Letter to KEIRO re R63M Payment (October 2025)
...
- **Entities:** v15 (9 persons, 10 organizations)
- **Relations:** v25 (74 relations across 22 types)
- **Events:** v35 (44 events from 2017-06-30 to 2025-10-23)
- **Timeline:** v24 (43 entries across 4 phases)
...
- **Civil Liability:** Trust breach, unauthorized transfers, fiduciary duty breaches
- **Evidence Strength:** STRONG
- **Entity ID:** PERSON_001 (Entities v15)

### Rynette Farrar (PERSON_002)
- **Criminal Liability:** Identity impersonation (95%+ achievable)
- **Civil Liability:** Payment redirection R4.3M, obstruction of access
- **Evidence Strength:** STRONG
- **Entity ID:** PERSON_002 (Entities v15)

### Danie Bantjies (PERSON_007)
- **Civil Liability:** Conspiracy to defraud, conflict of interest
- **Criminal Liability:** Potential accomplice liability
- **Evidence Strength:** MODERATE to STRONG
- **Entity ID:** PERSON_007 (Entities v15)

## Repository Structure

```
revstream1/
├── ANSWERING_AFFIDAVIT_REFINED_2025_12_11.md
├── CIPC_COMPLAINT_REFINED_2025_12_11.md
├── COMMERCIAL_CRIME_REFINED_2025_12_11.md
├── POPIA_COMPLAINT_REFINED_2025_12_11.md
├── NPA_TAX_FRAUD_REPORT_2025_12_11.md
├── BURDEN_OF_PROOF_ASSESSMENT_2025_12_11.json
├── LEGAL_FILINGS_SUMMARY_2025_12_11.md (this file)
├── data_models/
│   ├── entities/entities_refined_2025_12_11_v15.json
│   ├── relations/relations_refined_2025_12_11_v25.json
│   ├── events/events_refined_2025_12_11_v35.json
│   └── timelines/timeline_refined_2025_12_11_v24.json
└── docs/
...
1. ✅ **Data Models Updated** - Entities v15, Relations v25, Events v35, Timeline v24
2. 🔄 **Legal Filings Refinement** - In progress
3. 📝 **GitHub Pages Update** - Pending
4. 📦 **Submission Packages** - To be prepared
5. 🔗 **Cross-Reference Validation** - To be completed

## Change Log

### 2025-12-11
- Updated data models: Entities v14→v15, Events v34→v35, Relations v24→v25, Timeline v23→v24
- Enhanced evidence cross-references with ad-res-j7 repository
- Improved burden of proof assessments
- Added data model integration references

### 2025-12-10
- Initial comprehensive evidence integration
- SF9 integration (R63M payment demand)
- SF2A/SF2B integration (Rynette impersonation)
- Burden of proof assessments completed

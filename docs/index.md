...
## 🚨 NEW EVIDENCE: Peter Faucitt's FNB Fraud Letter (2025-06-17)

**CRITICAL DISCOVERY:** A letter from **Peter Andrew Faucitt** to **FNB** dated **17 June 2025** has been obtained, in which Peter:

1. **Acknowledges suspected fraud** on RWD account 62323196362
2. **Confirms prior request to cancel 3 debit cards** due to suspected fraud
3. **Warns FNB** about being an "accessory after the fact"
4. **Acknowledges potential Exchange Control violations** due to "dollar-based subscription expense"

### Why This Matters

This letter was written **11 days after** Daniel exposed fraud to Bantjies (2025-06-06) and **10 days after** the secret card cancellations (2025-06-07). It **directly contradicts** Peter's court position where he claims Daniel and Jax are the perpetrators.
...
**Key Evidence:** JF01, JF03, JF07, JF08, SF9, Ketoni Timeline, **FNB Fraud Letter**
...
| Director Misconduct | ✅ EXCEEDED | Fiduciary duty breach + **FNB Letter Admission** |

**Key Evidence:** JF04, JF14, JF15, SF1, SF2, SF6, SF7, **FNB Fraud Letter**
...
**Key Evidence:** JF03, SF1, SF3, SF4, **FNB Fraud Letter (Exchange Control)**
...
- **[Events Directory](./events/)** - Detailed event documentation (132 events)
- **[Relations Analysis](./relations/index.md)** - Entity relationship mapping (124 relations)
...
### Latest Filings (2026-01-29) - FNB Fraud Letter Integration

| Filing | Type | Status |
|--------|------|--------|
| [CIPC Complaint](./filings/CIPC_REFINED_2026_01_29.md) | Regulatory | 🆕 Updated with FNB Letter |
| [POPIA Complaint](./filings/POPIA_REFINED_2026_01_29.md) | Criminal | 🆕 Updated with FNB Letter |
| [NPA Tax Fraud Report](./filings/NPA_REFINED_2026_01_29.md) | Criminal | 🆕 Updated with Exchange Control |
| [Commercial Crime Submission](./filings/COMMERCIAL_CRIME_REFINED_2026_01_29.md) | Criminal | 🆕 Updated with FNB Letter |
...
- **[Rynette Organogram - Sales Process Flow (2025-04-12)](./evidence/organograms/rynette-organogram-2025-04-12.md)** - Complete sales process documentation revealing Kent, EL, Shopify-Sage automation, and Courier Guy logistics
...
- **FNB Letter Admission**: Acknowledged suspected fraud on RWD account (2025-06-17)
...
- **Letterhead Evidence**: FNB letter uses rynette@regima.zone as primary contact
- Evidence Strength: **Conclusive**
...
| Metric | Count |
|--------|-------|
| **Entities** | 90 (persons, organizations, trusts, domains, platforms) |
| **Events** | 132 documented events |
| **Relations** | 130 mapped relationships |
| **Timeline Entries** | 126 |
| **Criminal Threshold Events** | 53 |
| **Evidence Files** | 1,153+ unique references in ad-res-j7 |
...
- **Supporting Files** - SF1-SF10 documentation
...
**Total Evidence Files in ad-res-j7:** 1,153+ files
...
**Data Model Versions:**
- Entities: v29.0_FNB_FRAUD_LETTER_2026_01_29
- Events: v27.0_FNB_FRAUD_LETTER_2026_01_29

# Application 1: Civil Response (Case 2025-137857)

**Last Updated:** 2026-01-05

## Overview

This application contains the evidence and documentation for the answering affidavit in response to Peter Andrew Faucitt's interdict application in Case 2025-137857.

**Burden of Proof:** Balance of probabilities (50%)

## Evidence Structure

### Primary Annexures (JF Series)

All JF annexures are located in the [ad-res-j7/ANNEXURES](https://github.com/cogpy/ad-res-j7/tree/main/ANNEXURES) directory.
...
- **JF07:** Payment redirection documentation (186 items)
- **JF08:** Evidence Package - Comprehensive fraud timeline (43 items)
...
- **SF9:** Ian Levitt Attorney Memo

## Timeline Coverage

**Total Events:** 77  
**Events Meeting Civil Threshold (50%):** 31  
**Timeline Span:** 2017-02-24 to 2025-10-23

## Application Documents

Located in [ad-res-j7/1-CIVIL-RESPONSE](https://github.com/cogpy/ad-res-j7/tree/main/1-CIVIL-RESPONSE):
